...
<head>
    ...
    $temSkeleton = in_array($rota, ['login', 'cadastro', 'dashboard', 'perfil', 'rendas', 'despesas', 'recorrentes', 'categorias', 'relatorios', 'usuarios', 'avisos', 'mais']);
    if ($temSkeleton): ?>
    <style>
...
<body <?= ((isset($n_valida) && $n_valida == true) || $rota == 'relatorio') ? "class='flex-col h-auto'" : "" ?>>
    ...
    } elseif ($rota === 'recorrentes') {
        require_once __DIR__ . "/../skeletons/recorrentes.php";
