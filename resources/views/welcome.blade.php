    ...
    <header class="h-20 sticky top-0 z-50 bg-white shadow-md">
        <div class="interface flex justify-between items-center py-2">
            ...
            <nav class="flex items-center gap-5">
                ...
                <a class="py-2 px-4 rounded-lg bg-teal-600 text-white hover:bg-teal-700"
    ...
    <main>
            ...
            <div class="interface flex justify-between items-center gap-2">
                <div class="flex flex-col gap-3 text-white">
                    ...
                    <nav class="flex gap-2">
                        <a class="py-2 px-4 bg-white text-teal-600 rounded-lg border hover:bg-teal-600 hover:text-white hover:border-teal-600"
                            href="{{ route('login') }}">Começar agora</a>
                        <a class="py-2 px-4 rounded-lg border hover:bg-white hover:text-teal-600" href="#">Saiba
                            mais</a>
                    </nav>
                </div>
                <img class="w-2/5 rounded-lg" src="{{ Vite::asset('resources/images/img-hero.avif') }}"
                ...
                <div class="flex items-center justify-center gap-5 mt-5">
                    ...
                    <article class="card">
                        <x-heroicon-o-arrow-trending-down
                            class="w-12 h-12 p-1 bg-teal-600/20 text-teal-600 rounded-xl" />
                        <h3>Despesas</h3>
                        <p>
        ...
        <section id="diferencial">
            <div class="interface flex justify-between gap-5">
                <div class="flex flex-col gap-5 w-1/2">
                    ...
                    <a class="bg-teal-600 text-white px-6 py-3 rounded-xl w-max hover:bg-teal-700"
                        href="{{ route('register') }}">Criar conta grátis</a>
                </div>
            ...
            <div class="interface flex flex-col items-center justify-center gap-5">
                ...
                <div class="flex items-center justify-center gap-5">
                    <article class="card-cliente">
                        ...
                        <p class="txt-cliente">
                            "O EcoFlow mudou minha relação com o dinheiro. Agora consigo visualizar exatamente para onde
                            vai meu salário e planejar melhor meu futuro."
                        </p>
                        <div class="stars">
                    ...
                    <article class="card-cliente">
                        <div class="img-nome">
                            <img src="{{ Vite::asset('resources/images/carlos.avif') }}"
                                alt="Imagem do cliente Carlos">
                            <div>
                                <h3>Carlos Mendes</h3>
                                <p>Empresário</p>
                            </div>
                        ...
                        <p class="txt-cliente">
                            "Como empreendedor, precisava de uma ferramenta que me ajudasse a separar finanças pessoais
                            e da empresa. O EcoFlow faz isso de forma brilhante."
                        </p>
                        <div class="stars">
                            <x-heroicon-s-star class="w-6 h-6" />
                            <x-heroicon-s-star class="w-6 h-6" />
                    ...
                    <article class="card-cliente">
                        ...
                        <p class="txt-cliente">
                            "Comecei a usar para controlar meus gastos na faculdade e agora consigo economizar para meus
                            objetivos sem abrir mão da diversão!"
                        </p>
                        <div class="stars">
                            <x-heroicon-s-star class="w-6 h-6" />
                            <x-heroicon-s-star class="w-6 h-6" />
        ...
        <section class="bg-teal-600 inset-shadow-500 text-white">
            <div class="interface flex flex-col items-center justify-center gap-5">
                ...
                <nav class="flex gap-2">
                    <a class="bg-white text-teal-600 py-2 px-4 rounded-xl hover:bg-gray-100"
                        href="{{ route('register') }}">Criar conta grátis</a>
                    <a class="border text-white py-2 px-4 rounded-xl hover:bg-white hover:text-teal-600"
