    ...
    try {
        ...
        if ($stmt->execute()) {
            if ($stmt->affected_rows > 0) {
                $_SESSION['resposta'] = "Categoria excluída com sucesso!";
            } else {
                $_SESSION['resposta'] = "Não foi possível excluir a categoria!";
            }
        } else {
            $_SESSION['resposta'] = "Ocorreu um erro ao tentar excluir a categoria.";
        }
