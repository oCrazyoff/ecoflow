    ...
    try {
        ...
        if ($stmt->execute()) {
            if ($stmt->affected_rows > 0) {
                $_SESSION['resposta'] = "Usuário excluído com sucesso!";
            } else {
                $_SESSION['resposta'] = "Não foi possível excluir o usuário. Verifique as permissões.";
            }
        } else {
            $_SESSION['resposta'] = "Ocorreu um erro ao tentar excluir o usuário.";
        }
