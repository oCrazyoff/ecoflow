                ...
                <?php foreach ($despesas as $row): ?>
                    <div
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-sm text-gray-600 -mt-2">
                            <span
                                class="bg-blue-50 text-blue-600 px-2 py-0.5 rounded"><?= htmlspecialchars($row['nome_categoria']) ?></span>
                            <span>&bull;</span>
                            ...
                            <?php if (!empty($row['parcela_grupo'])): ?>
                                ...
                                <span
                                    ...
                                    <span class="font-semibold"><?= $row['parcela_numero'] ?></span>
                            ...
                            <?php else: ?>
                                ...
                                <button data-id="<?= $row['id'] ?>" onclick="trocarRecorrente(this)"
                                    ...
                                    <?php if ($row['recorrente'] == 1): ?>
                                        <span
                                            class="bg-teal-50 text-teal-600 px-2 py-0.5 rounded flex items-center gap-1 btn-recorrente-mobile">
                                            <i class="bi bi-arrow-repeat"></i> Recorrente
                                        </span>
                                    <?php else: ?>
                                        <span
                                            class="bg-gray-100 text-gray-500 px-2 py-0.5 rounded flex items-center gap-1 btn-recorrente-mobile">
                                            Não Recorrente
                                        </span>
                                    <?php endif; ?>
                                </button>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <button data-id="<?= $row['id'] ?>" onclick="trocarRecorrente(this)">
                                            <?php if ($row['recorrente'] == 1): ?>
                                                <span
                                                    class="whitespace-nowrap w-full border border-borda bg-teal-50 text-teal-600 rounded-full px-5 py-1 btn-recorrente-desktop">
                                                    Recorrente
                                                </span>
                                            <?php else: ?>
                                                <span
                                                    class="whitespace-nowrap w-full border border-borda bg-gray-100 text-gray-500 rounded-full px-5 py-1 btn-recorrente-desktop">
                                                    Não Recorrente
                                                </span>
                                            <?php endif; ?>
                                        </button>
